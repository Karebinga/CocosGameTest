System.register(["__unresolved_0", "cc", "@vkontakte/vk-bridge"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, KeyCode, input, Input, Vec2, RigidBody2D, BoxCollider2D, Contact2DType, Label, bridge, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, Player;
  ...
  function _reportPossibleCrUseOfbridge(extras) {
    _reporterNs.report("bridge", "@vkontakte/vk-bridge", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      Label = _cc.Label;
    }, function (_vkontakteVkBridge) {
      bridge = _vkontakteVkBridge.default;
    }],
    execute: function () {
      _crd = true;
...
//# sourceMappingURL=75b9bb32b7a1aa42126c92400935da1487ffeb8b.js.map